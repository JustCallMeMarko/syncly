...
public class NotifAdapter extends RecyclerView.Adapter<TaskSchedViewHolder> {
    Context context;
    List<TaskSchedData> items;

    public NotifAdapter(Context context, List<TaskSchedData> items) {
    ...
    public TaskSchedViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new TaskSchedViewHolder(LayoutInflater.from(context).inflate(R.layout.item_notif, parent, false));
    }
